...
def selection_options():
    result = [[]]
    result[0].append(system.SelectionOption("window_mode", "SCREEN, WINDOW MODE:", str(config.settings['window_mode']).upper(), "multi", [config.WINDOW_MODE_NORMAL, config.WINDOW_MODE_BORDERLESS, config.WINDOW_MODE_FULLSCREEN]))
